  ...
  return (
    <div id="history">
      <div className="items-container">
        <h1 className="title ">Parcours professionnel</h1>
        <VerticalTimeline>
          ...
          >
            ...
            <p>
              ...
              <br />
              <br />
              Technologies des projets en cours: Angular, Php, Algorithmie, React, TypeScript, Wordpress, Python.
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          >
            ...
            <p>
              ...
              <br />
              <br />Technologies des projets: JavaScript, HTML5, CSS3, SASS, Node.js, Express, PostgreSQL
            </p>
          </VerticalTimelineElement>
